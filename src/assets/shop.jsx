    ...
    <div>
      ...
      <div className="lg:flex lg:gap-4 items-start">
        <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3">
          <Item
            itemImage="./images/image-waffle-mobile.jpg"
            itemImageDesktop="./images/image-waffle-desktop.jpg"
            title="Waffle"
          ...
          />
          <Item
            itemImage="./images/image-creme-brulee-mobile.jpg"
            itemImageDesktop="./images/image-creme-brulee-desktop.jpg"
            title="Crème Brûlée"
          ...
          />
          <Item
            itemImageDesktop="./images/image-macaron-desktop.jpg"
            itemImage="./images/image-macaron-mobile.jpg"
            title="Macaron"
          ...
          />
          <Item
            itemImageDesktop="./images/image-tiramisu-desktop.jpg"
            itemImage="./images/image-tiramisu-mobile.jpg"
            title="Tiramisu"
          ...
          />
          <Item
            itemImageDesktop="./images/image-baklava-desktop.jpg"
            itemImage="./images/image-baklava-mobile.jpg"
            title="Baklava"
          ...
          />
          <Item
            itemImageDesktop="./images/image-meringue-desktop.jpg"
            itemImage="./images/image-meringue-mobile.jpg"
            title="Pie"
          ...
          />
          <Item
            itemImageDesktop="./images/image-cake-desktop.jpg"
            itemImage="./images/image-cake-mobile.jpg"
            title="Cake"
          ...
          />
          <Item
            itemImageDesktop="./images/image-brownie-desktop.jpg"
            itemImage="./images/image-brownie-mobile.jpg"
            title="Brownie"
          ...
          />
          <Item
            itemImageDesktop="./images/image-panna-cotta-desktop.jpg"
            itemImage="./images/image-panna-cotta-mobile.jpg"
            title="Panna Cotta"
